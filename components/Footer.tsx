  ...
  return (
    <footer className="bg-soft_green-secondary relative pt-12 xl:pt-0">
      <div className="container mx-auto">
        ...
        >
          <div className="flex flex-col xl:flex-row bg-white p-8 rounded-xl xl:p-20 xl:-translate-y-36 xl:gap-x-12 min-h-[394px]">
            <div className="xl:w-[470px] mb-6 xl:mb-0">
              ...
              <p className="text-lg leading-9">
                ...
                Quibusdam dolorem, eligendi illo ipsam sapiente amet quae ipsum
                maxime, minus mollitia porro quia earum quis quas?
              </p>
            </div>
            <div className="flex xl:gap-x-16 xl:ml-32">
              <div className="flex-1">
                ...
                <ul className="flex flex-col gap-y-6 text-lg">
                  ...
                  <li>
                    <Link href={"/find"}>Find Hotel</Link>
                  </li>
                  <li>
